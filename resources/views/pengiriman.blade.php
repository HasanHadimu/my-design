        ...
        <header class="font-poppins">
            <div class="py-6">
                <div class="pl-4 text-sm font-medium flex items-start gap-x-1">
                    ...
                    <a href="/pemesanan" class="text-gray-900 hover:text-yellow-400 transition duration-400">Form Konsultasi
                    </a>
                </div>
                <div>
                    <h1 class="text-3xl font-bold pl-4 text-gray-700">Form Konsultasi</h1>
                </div>
            </div>
        </header>
        ...
        <main class="px-4 py-8 font-poppins bg-slate-100 lg:px-20">
            <form action="{{ route('struk') }}" method="POST">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <!-- Kota -->
                    <div>
                        <label for="kota" class="block mb-2 text-sm font-medium text-gray-900">Pilih Kota</label>

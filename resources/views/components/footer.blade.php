<footer class="bg-zinc-900">
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 pt-16 pb-7 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            <div>
                <div class="text-yellow-400 font-poppins flex items-center gap-x-4">
                    <img src="{{ asset('images/' . 'puy.jpeg') }}" alt="" class="h-20 rounded-full" />
                    <h1 class="font-semibold text-3xl">My Design</h1>
                </div>
                <p class="mt-4 max-w-xs text-slate-100">Solusi desain terpercaya untuk mewujudkan ide dan gaya hidup Anda.</p>
                ...
                <ul class="mt-8 flex gap-6">
                    ...
                    <li>
                        <a href="https://www.instagram.com/daffa_hq/" rel="noreferrer" target="_blank"
                            class="text-yellow-400 transition hover:opacity-75">
                    ...
                    <ul class="mt-6 space-y-4 text-md font-poppins">
                        <li class="flex items-center gap-x-4">
                            ...
                            <a href="#" target="_blank" class="text-slate-100 transition hover:opacity-75">
                                Jl. Palem Ganda Asri, Blok A6 No.4, Tangerang, Indonesia </a>
                        </li>
                        ...
                        <li class="flex items-center gap-x-4">
                            ...
                            <a href="https://wa.me/6285777818634" target="_blank"
                                class="text-slate-100 transition hover:opacity-75"> 0857-7781-8634 </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col-span-3 space-y-6">
                        <div>
                            ...
                            <p class="mt-2 text-gray-500 font-poppins pr-8">Masukkan nomor whatsapp anda di bawah untuk
                                berlangganan informasi dan promosi terbaru seputar My Design.</p>
                        </div>
                            ...
                            <form class="w-full" name="submit-to-google-sheet">
                                ...
                                <div id="success-message"
                                    ...
                                    <div><span class="font-medium">Berhasil!</span> Nomormu telah masuk dalam
                                        daftar berlangganan informasi seputar My Design.</div>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <p class="text-sm text-slate-100 font-poppins">&copy; 2024. My Design. All rights reserved.</p>
        <script>
            const scriptURL =

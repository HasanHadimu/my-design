<nav class="absolute top-0 left-0 w-full bg-black/50 z-50 font-poppins">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://www.instagram.com/daffa_hq/" 
           class="flex items-center space-x-2 rtl:space-x-reverse" 
           target="_blank">
            <span class="text-2xl font-medium whitespace-nowrap text-yellow-400">
                My Design
            </span>
            <span class="text-2xl font-medium whitespace-nowrap text-white">
                Kreasi Indonesia
            </span>
        </a>

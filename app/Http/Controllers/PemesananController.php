...
class PemesananController extends Controller
{
    ...
    public function index()
    {
        ...
        $menuItems = MenuItem::select('name', 'slug', 'photo')->get();

        // Mengirim data ke view
        return view('pemesanan')->with($this->viewData('Portofolio - My Design', 'pemesanan', $menuItems));
    }
